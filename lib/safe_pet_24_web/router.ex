defmodule SafePet24Web.Router do
  use SafePet24Web, :router

  import SafePet24Web.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {SafePet24Web.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: SafePet24Web.Telemetry
    end
  end
